...
contract GoodRussians is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function changeCurrentFee(uint256 newFee) public onlyOwner {
        require(newFee >= 1 && newFee <= 146, "Incorrect");
    ...
    returns (string memory)
    {
        ...
        parts[
        0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 160 160"><style>.number { fill: white; font-family: serif; font-size: 32px; }</style> <style>.name { fill: white; font-family: serif; font-size: 16px; }</style><rect width="100%" height="100%" fill="black" /><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" class="number">';
    ...
    function sponsor(uint256 tokenId) public payable nonReentrant {
        require(tokenId > 0 && tokenId <= currentGoodRussians, "Not yet");
        require(msg.value >= currentFee && msg.value <= 146*(10**18), "Value is wrong");
